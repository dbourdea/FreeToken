...
- Local deterministic verification on the current Windows checkout: 304 daemon
...
- GitHub-hosted Ubuntu verification at
  `3b257bd853205cf85e830036ceb7541571f7f94b` (Actions run `34923302826`)
  reported 295 passed with zero failures, errors, or skips. This includes the
  ...
  metadata, management-isolation, reload-reset, and qualifier gates.
