...
router-cancellation, same-model-concurrency, failed-switch rollback,
active-reload-conflict, and TTL-eviction results. It must also run Linux real-child
tests and exercise accounting and re-adoption on
