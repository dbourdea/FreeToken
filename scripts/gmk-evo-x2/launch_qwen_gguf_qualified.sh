#!/usr/bin/env bash
# Start or stop the qualified GMKtek EVO-X2 Qwen3.6 Q4_K_M FreeToken test server.
#
...
# that makes a PID or process-group signal safe in a shared GMKtek EVO-X2 shell.
